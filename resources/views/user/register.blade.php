                            ...
                            <div class="woocommerce">
                                <div class="woocommerce-login">
                                    <div class="company-info signin-register">
                                                ...
                                                <form class="register-form login" method="post" action="/user-register" enctype="multipart/form-data">
                                                    @csrf 
                                                    <p class="form-row input-required">
                                                        <label>
                                                            <h5 class=theading>Full Name</h5>
                                                        </label>
                                                    ...
                                                    <p class="form-row input-required">
                                                        <label>
                                                            <h5 class=theading>Re-type Password</h5>
                                                        </label>
                                                    ...
                                                    <p class="form-row input-required">
                                                        <label>
                                                            <h5 class=theading>Email Address</h5>
                                                        </label>
                                                    ...
                                                    <p class="form-row input-required">
                                                        <label>
                                                            <h5 class=theading>Phone Number</h5>
                                                        </label>
                                                        <input type="number" name="number" class="input-text" required>
                                                    </p>
