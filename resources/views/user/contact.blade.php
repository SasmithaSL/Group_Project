                            ...
                            <div class="container">
                                <div class="contact-location">
                                    <div class="flipcard">
                                        <div class="front">
                                            <div class="top-info">
                                                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Bookshop Address</span>
                                            </div>
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li> 31/2 Main Street, </li>
                                                    <li> Kurunegala , Srlanka</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="back">
                                    ...
                                    <div class="flipcard">
                                        <div class="front">
                                            ...
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li><a href="#">Phone: +037-226-7890</a></li>
                                                    <li><a href="#">Fax: (037)-254-7359</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="back">
